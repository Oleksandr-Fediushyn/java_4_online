...
public class EmployeeServiceTests {
    ...
    public void findEmployeeById(){
        Employee employee = employeeService.findAllEmployees().stream().toList().get(0);
        Assertions.assertEquals(employeeService.findEmployeeById(employee.getId()).getId(), employee.getId());
    }
   ...
   @Order(4)
    ...
    public void updateEmployeeTest() {
       Employee current = employeeService.findAllEmployees().stream().toList().get(0);
       current.setAge(35);
       employeeService.updateEmployee(current);
       Assertions.assertNotEquals(employeeService.findAllEmployees().stream().toList().get(0).getAge(), age);
    }
    ...
    public void attachEmployeeToProject() {
        ...
        for (int i = 0; i < SIZE; i++) {
            Employee attachEmployee = employeeService.findAllEmployees().stream().toList().get(i);
            currentProject = employeeService.findAllProjects().stream().toList().get(0);
    ...
    public void findEmployeeByProjectId() {
        Project currentProject = employeeService.findAllProjects().stream().toList().get(0);
    ...
    public void findProjectById(){
        Project project = employeeService.findAllProjects().stream().toList().get(0);
        Assertions.assertEquals(employeeService.findProjectById(project.getId()).getId(), project.getId());
    }
    ...
    public void deleteEmployeeFromProject() {
        Project currentProject = null;
        for (int i = 0; i < SIZE; i++) {
            Employee deleteEmployee = employeeService.findAllEmployees().stream().toList().get(i);
            currentProject = employeeService.findAllProjects().stream().toList().get(0);
    ...
    public void updateProjectTest() {
        ...
        Assertions.assertNotEquals(employeeService.findAllProjects().stream().toList().get(0).getLocation(), location);
    }
